...
int main()
{
    ...
    Model amodel = Model();
    amodel.load(vertices, sizeof(vertices) / sizeof(vertices[0]), indices, sizeof(indices) / sizeof(indices[0]), "resource/pics/grass_brick.png");

    Shader shader = Shader("resource/shader/vshader", "resource/shader/fshader");
